                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      Row(children: [
                        ...
                        Expanded(child: Text(" / Free",style: TextStyle(fontSize: 24,fontWeight: FontWeight.w600),)),
                      ],),
                        SizedBox(height: 20,),
                        Text("Can you imagine all these expensive services been served for free!?",maxLines: 2,overflow: TextOverflow.fade,style: TextStyle(fontSize: 14,color: color555555),),
                      ],
                    ),
                  ),
                ),
